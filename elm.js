	...
	function (msg, model) {
		if (msg.$ === 'TouchStart') {
			...
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{message: 'Touchstart detected with debug info: ' + debugInfo}),
				$elm$core$Platform$Cmd$none);
		} else {
			return _Utils_Tuple2(
				_Utils_update(
...
var $author$project$Main$rawEventDecoder = A2(
	$elm$json$Json$Decode$map,
	function (v) {
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$elm$html$Html$Events$on,
				'touchstart',
				A2($elm$json$Json$Decode$map, $author$project$Main$TouchStart, $author$project$Main$rawEventDecoder)),
				A2(
				$elm$html$Html$Events$on,
				'touchend',
