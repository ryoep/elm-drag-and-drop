	...
	function (msg, model) {
		switch (msg.$) {
			case 'StartDrag':
				...
				if (_v1.$ === 'Just') {
					var square = _v1.a;
					var offsetY = startY - square.top;
					var offsetX = startX - square.left;
					return _Utils_update(
						model,
						{
							dragInfo: $elm$core$Maybe$Just(
								{id: id, offsetX: offsetX, offsetY: offsetY, startX: startX, startY: startY})
						});
				} else {
					return model;
				}
			case 'Drag':
				var x = msg.a;
				var y = msg.b;
				var _v2 = model.dragInfo;
				if (_v2.$ === 'Just') {
					var info = _v2.a;
					var newSquares = A2(
						$elm$core$List$map,
						function (sq) {
							return _Utils_eq(sq.id, info.id) ? _Utils_update(
								sq,
								{left: x - info.offsetX, top: y - info.offsetY}) : sq;
						},
						model.squares);
					return _Utils_update(
						model,
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				A2($elm$html$Html$Attributes$style, 'background-color', square.color),
				A2(
				$elm$html$Html$Attributes$style,
				'top',
				$elm$core$String$fromFloat(square.top) + 'px'),
				A2(
				$elm$html$Html$Attributes$style,
				'left',
...
var $author$project$Main$view = function (model) {
	return A2(
		...
		A2($elm$core$List$map, $author$project$Main$viewSquare, model.squares));
};
var $author$project$Main$main = $elm$browser$Browser$sandbox(
	{init: $author$project$Main$init, update: $author$project$Main$update, view: $author$project$Main$view});
_Platform_export({'Main':{'init':$author$project$Main$main(
	$elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.1"},"types":{"message":"Main.Msg","aliases":{},"unions":{"Main.Msg":{"args":[],"tags":{"StartDrag":["Basics.Int","Basics.Float","Basics.Float"],"Drag":["Basics.Float","Basics.Float"],"EndDrag":[],"DuplicateSquare":["Basics.Int"]}},"Basics.Float":{"args":[],"tags":{"Float":[]}},"Basics.Int":{"args":[],"tags":{"Int":[]}}}}})}});}(this));